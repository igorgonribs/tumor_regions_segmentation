...
def train_model_with_validation(dataloaders,
                                ...
                                result_file_csv="../../datasets/BONE_CHANNELS_reduced_size/training/bones_training_accuracy_loss.csv"):
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        if (epoch % 5 == 0):
            filename = save_model(output_dir, model, patch_size, n_epochs, qtd_images , batch_size, augmentation, optimizer, loss)
        ...
        with open(result_file_csv, mode='a+') as csv_file:
            ...
            for phase in ['train', 'test']:
                ...
                print('[{}] Accuracy: {:.6f}'.format(phase, epoch_acc[phase]))
...
def save_model(model_dir, model, patch_size, epoch, imgs, batch_size, augmentation_strategy, optimizer, loss):
    ...
    """
    filename = 'BONE_CHANNELS_reduced_size__Size-{}x{}_Epoch-{}_Images-{}_Batch-{}__{}_all.pth'.format(patch_size[0], patch_size[1], epoch, imgs, batch_size, augmentation_strategy)
...
if __name__ == '__main__':
    ...
    trained_model_version = "BONE_CHANNELS_reduced_size__Size-reduced_size_Epoch-001_Images-100_Batch-1__no_augmentation"
    ...
    # train the model
    result_file_csv = "../../datasets/BONE_CHANNELS_reduced_size/training/bones_training_accuracy_loss_all.csv"
